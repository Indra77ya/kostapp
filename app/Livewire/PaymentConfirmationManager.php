...
class PaymentConfirmationManager extends Component
{
    ...
    public function approve($id)
    {
        ...
        BroadcastHelper::safeBroadcast(new NotificationSent($message, 'success', $tenantId));
    ...
    public function reject($id)
    {
        ...
        if ($payment) {
            ...
            // Notify the tenant privately
            BroadcastHelper::safeBroadcast(new NotificationSent("Pembayaran untuk {$billDescription} ditolak.", 'warning', $tenantId));
