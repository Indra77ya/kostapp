          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                @endhasanyrole
                @hasanyrole('owner|developer|admin')
                <li class="nav-item dropdown {{ request()->routeIs(['payments.*', 'deposits.*']) ? 'active' : '' }}">
                  <a class="nav-link dropdown-toggle" href="#navbar-pembayaran" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item {{ request()->routeIs('analytics.*') ? 'active' : '' }}">
                  <a class="nav-link" href="{{ route('analytics.index') }}">
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chart-pie" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 3.2a9 9 0 1 0 10.8 10.8a1 1 0 0 0 -1 -1h-6.8a1 1 0 0 1 -1 -1v-6.8a1 1 0 0 0 -1 -1z" /><path d="M15 3.5a9 9 0 0 1 5.5 5.5h-4.5a1 1 0 0 1 -1 -1v-4.5z" /></svg>
                    </span>
                    <span class="nav-link-title">
                      Analytics &amp; Laporan
                    </span>
