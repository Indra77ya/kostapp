<div>
    <div class="row mb-3 align-items-center">
        <div class="col">
            <h2 class="page-title">Manajemen Peraturan</h2>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Impor Data Peraturan</h5>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text small text-secondary mt-2">
                                <ul class="ps-3 mb-0">
                                    ...
                                    <li>Kolom <strong>Nama Lokasi</strong> opsional (kosongkan jika berlaku Global untuk semua lokasi).</li>
                                    <li>Untuk memperbarui data peraturan yang ada, sertakan nilai <strong>ID Ekspor</strong> dari file ekspor sistem.</li>
                                    <li>Jika terdapat duplikasi peraturan atau lokasi belum ada, seluruh proses impor akan dibatalkan.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
