                    ...
                    <tbody>
                        @forelse($tenantBills as $bill)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('tenant.payments', ['bill_id' => $bill->id]) }}" class="btn btn-primary btn-sm px-2 py-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-credit-card me-1" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 5m0 3a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v10a3 3 0 0 1 -3 3h-12a3 3 0 0 1 -3 -3z" /><path d="M3 10l18 0" /><path d="M7 15l2 0" /><path d="M11 15l2 0" /></svg>
                                        Bayar
                                    </a>
                                </td>
                            </tr>
