            ...
            <div class="row g-2">
                ...
                <div class="col-md-3">
                    <select class="form-select" wire:model.live="sortOrder">
                        <option value="room_number_asc">Urutkan: No. Kamar (↑)</option>
                        <option value="room_number_desc">Urutkan: No. Kamar (↓)</option>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Impor Data Kamar</h5>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text small text-secondary mt-2">
                                <ul class="ps-3 mb-0">
                                    ...
                                    <li>Kolom <strong>Nama Lokasi</strong> wajib sesuai dengan nama lokasi yang ada di sistem.</li>
                                    <li>Untuk memperbarui data kamar yang ada, sertakan nilai <strong>ID Ekspor</strong> dari file ekspor sistem.</li>
                                    <li>Jika terdapat duplikasi nomor kamar pada lokasi yang sama atau lokasi belum ada, seluruh proses impor akan dibatalkan.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
