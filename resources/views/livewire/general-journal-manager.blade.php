<div>
    <div class="row mb-3 align-items-center d-print-none">
        ...
        <div class="col-auto ms-auto d-flex align-items-center gap-2">
            <a href="{{ route('accounting.export', ['type' => 'journal', 'date_start' => $filterDateStart, 'date_end' => $filterDateEnd, 'search' => $search]) }}" class="btn btn-outline-success">
                            ...
                            @foreach($items as $idx => $item)
                                <div class="row g-2 mb-2 align-items-center">
                                    ...
                                    <div class="col-md-1 text-center">
                                        @if(count($items) > 2)
                                            <button type="button" wire:click="removeItem({{ $idx }})" class="btn btn-ghost-danger btn-icon" title="Hapus Baris">
